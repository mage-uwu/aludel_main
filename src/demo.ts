...
export const seed = (): void => {
  ...
  store.submit([{ type: "signed", template: { id: tpl, version: 1, name: "Pool report", tasks: [
    { key: "clean", title: "Weekly clean", cadence: { every: 1, unit: "week", withinDays: 3 }, blocks: [
      ...
      { key: "photo", kind: "photo", label: "Photo of the water", required: false },
      { key: "notes", kind: "text", label: "Notes", required: false, placeholder: "anything worth flagging" },
    ], outcomes: [{ key: "OPEN", label: "OPEN", cost: 1 }, { key: "CLOSED", label: "CLOSED", cost: 1 }, { key: "NO_ACCESS", label: "NO ACCESS", cost: 0 }] },
    { key: "drain", title: "Drain and fill", cadence: { every: 10, unit: "week", withinDays: 21 }, blocks: [
